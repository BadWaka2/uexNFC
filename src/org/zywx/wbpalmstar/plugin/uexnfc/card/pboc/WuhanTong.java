...
final class WuhanTong extends PbocCard {
	...
	private final static byte[] DFN_SRV = { (byte) 0x41, (byte) 0x50, (byte) 0x31, (byte) 0x2E, (byte) 0x57,
			(byte) 0x48, (byte) 0x43, (byte) 0x54, (byte) 0x43, };

	private WuhanTong(Iso7816.Tag tag, Resources res) {
		super(tag);
		name = EUExUtil.getString("plugin_uexnfc_name_wht");
	}
	...
	private void parseInfo(Iso7816.Response sn, Iso7816.Response info) {
		...
		date = String.format("%02X%02X.%02X.%02X - %02X%02X.%02X.%02X", d[20], d[21], d[22], d[23], d[16], d[17], d[18],
				d[19]);
		count = null;
	}
}
